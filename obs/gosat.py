...
#         gosat_sampl.gen_hm(sampl_file)
        hm_file = sampl_file
        gosat_sampl.add_project_tag(hm_file, sampl_file)
        #hm = xr.open_dataset('/data/shzhu/global_inv/sampl_rlt_2x25/GOSAT/gosat_sampl.'+ day.strftime('%Y-%m-%d')+'.nc')['hm']
#         hm_file = '/data/shzhu/org_ch4/global_2x25/GOSAT_FF_AN_NA/YYYY/gosat_sampl.'.replace('YYYY', day.strftime('%Y'))
#         hm_file =  hm_file+ day.strftime('%Y%m%d')+'.nc'
#         gosat_sampl.gen_hm0(hm_file, sampl_file)
