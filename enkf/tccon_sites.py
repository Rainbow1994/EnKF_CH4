...
tccon_site = {'site_id': np.array(['ae', 'an', 'bi', 'br', 'bu', 'ci', 'db', 'df', 'et', 'eu', 'fc',\
                                   ...
                                   'ma', 'oc', 'or', 'pa', 'pr', 'ra', 'rj', 'so', 'sp', 'tk', 'wg',\
                                   'zs'], dtype=object),
              'long_name': np.array(['ascension01', 'anmeyondo01', 'bialystok01', 'bremen01',\
                                  ...
                                  'lamont01', 'orleans01', 'parkfalls01', 'paris01', 'reunion01',\
                                  'rikubetsu01', 'sodankyla01', 'nyalesund01', 'tsukuba02',\
                                  'wollongong01', 'zugspitze01'], dtype=object),
              'longitude': np.array([ -14.33,  126.33,   23.02,    8.85,  120.65, -118.13,  130.89,\
                                  ...
                                  169.68,  -60.6 ,  -97.49,    2.11,  -90.27,    2.36,   55.49,\
                                  143.77,   26.63,   11.92,  140.12,  150.88,   10.98],dtype=np.float32),
              'latitude': np.array([ -7.92,  36.54,  53.23,  53.1 ,  18.53,  34.14, -12.43,  34.96,\
                                 54.36,  80.05,  36.8 ,  47.48,  31.9 ,  39.86,  28.3 ,  34.2 ,\
                                 34.2 ,  33.24,  49.1 , -45.05, -45.04, -45.04,  -3.21,  36.6 ,\
                                 47.97,  45.94,  48.85, -20.9 ,  43.46,  67.37,  78.92,  36.05,\
                                 -34.41,  47.42], dtype=np.float32)}
